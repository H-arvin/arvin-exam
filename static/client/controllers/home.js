controllers.controller("home", ["$scope", "certificateService", "$modal", "loading", "confirmModal", "msgModal", "$location", function ($scope, certificateService, $modal, loading, confirmModal, msgModal, $location) {
