...
app.config(["$stateProvider", "$urlRouterProvider", "$httpProvider", function ($stateProvider, $urlRouterProvider, $httpProvider) {
    ...
    $stateProvider.state('home', {
        ...
        .state('operate_history', {
            url: "/operate_history",
            controller: "operate_history",
            templateUrl: static_url + "client/views/history/operate_history.html"
        })
        .state('host_list', {
            url: "/host_list",
            controller: "host_list",
            templateUrl: static_url + "client/views/arvintest/host_list.html"
        })
    ;
